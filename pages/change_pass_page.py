...
class ChangePassPage(BasePage):
    # RT013 метод проверки типа восстановлени€ парол€ по умолчанию
    ...
    # RT014 метод проверки на валидацию пол€ ввода номера телефона /почты /логина /лицевого счета (ввод валидного номера)
    ...
    # RT015 метод проверки на валидацию пол€ ввода номера телефона /почты /логина /лицевого счета (ввод валидного email)
    ...
    # RT018 метод проверки восстановлени€ парол€ с незаполненными пол€ми
    ...
    # RT019 метод проверки восстановлени€ парол€ с незаполненным значением капчи
    ...
    # RT020 метод проверки текстового пол€ на SQL-инъекции
